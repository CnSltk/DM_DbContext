...
public partial class MasterContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=DeviceManager");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DeviceType>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__DeviceTy__737584F67AE0C1FF").IsUnique();
        ...
        modelBuilder.Entity<Person>(entity =>
        {
            ...
            entity.HasIndex(e => e.PassportNumber, "UQ__Person__45809E71BBADBA6D").IsUnique();

            entity.HasIndex(e => e.PhoneNumber, "UQ__Person__85FB4E389589FEA8").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Person__A9D105343F3382AA").IsUnique();
        ...
        modelBuilder.Entity<Position>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__Position__737584F68CA3CDBC").IsUnique();
